...
<body>
  ...
  <nav class="navbar fixed-top navbar-dark bg-dark" style="height:70px">
		<div class="container-fluid">
			...
			<button class="logout_but" type="button">Logout</button>
		</div>
	</nav>
	...
	<div class="maincontent">
		...
		<form action="<?php $_PHP_SELF ?>" target="" method="POST">
		  ...
		  <input type="text" name="pname" placeholder="Enter PName" required><br><br>
			...
			<input type="text" name="wardno" placeholder="Enter Ward No." required><br><br>
			Enter Gender:<br>
			...
			<input type="submit" value="Add Patient" onclick="myfunc();">
		</form>
	</div>
	<?php
		error_reporting (E_ALL ^ E_NOTICE);	$servername="localhost";
	$username="root";
	...
	$stmt->bind_param('isissisiss',$pid,$pname,$age,$phno,$disease,$docid,$admitdate,$wardno,$pgender,$paswd);
	$stmt->execute();
	?>
