...
<body>
  ...
  <nav class="navbar fixed-top navbar-dark bg-dark" style="height:70px">
		<div class="container-fluid">
			...
			<button class="logout_but" type="button" onclick='window.location.href="http://localhost/loginpage.php"'>Logout</button>
		</div>
	</nav>
	...
	<div class="maincontent">
		...
		<form action="<?php $_PHP_SELF ?>" target="" method="POST">
			...
			<input type="submit" value="Add Treatment" onclick="myfunc();">
		</form>
	</div>
	<?php
